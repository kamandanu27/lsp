                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="form-group">
												...
												<select class="input-group col-sm-8 col-md-8" id="jeniskelamin_asesi" name="jeniskelamin_asesi">
                      ...
                      <div class="form-group">
												...
												<select class="input-group col-sm-8 col-md-8" id="agama_asesi" name="agama_asesi">
													<option value="">Pilih</option>
