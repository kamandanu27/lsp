                  ...
                  <div class="box-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="nim_asesi">Nim</label>
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="nik_asesi">Nik</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="nama_asesi">Nama</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="alamat_asesi">Alamat</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="notlp_asesi">No. Telp</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          ...
                          <select class="input-group col-md-8" id="jeniskelamin_asesi" name="jeniskelamin_asesi">
                        ...
                        <div class="form-group">
                          ...
                          <select class="input-group col-md-8" id="agama_asesi" name="agama_asesi">
                            <option value="">Pilih</option>
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="tempatlahir_asesi">Tempat Lahir</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="tanggallahir_asesi">Tanggal Lahir</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="provinsi_asesi">Provinsi</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="kotakab_asesi">Kota / Kabupaten</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="tahunmasuk_asesi">Tahun Masuk</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="tahunlulus_asesi">Tahun Lulus</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="jurusan_asesi">Jurusan</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="programstudi_asesi">Program Studi</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="email_asesi">Email</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="nik_asesi">Password</label>
                          <div class="input-group col-md-8">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 col-form-label">Foto Asesi</label>
